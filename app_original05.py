...
with col_buy:
    ...
    with st.container(border=True):
        ...
        with st.expander("Expand", expanded=False):
            ...
            with col2:
                refi_costs = st.number_input("Refinance Closing Costs ($)", value=0.0, step=500.0, min_value=0.0, help="One-time costs for refinancing.")
                ...
                if refi_buy_points:
                    c1, c2 = st.columns(2)
                    with c1:
                        refi_points = st.number_input("Refinance Points", value=0.0, step=0.25, min_value=0.0, help="Points purchased for refinance.")
...
with st.container(border=True):
    ...
    with col2:
        ...
        fig_rent_cost_types.add_trace(go.Bar(x=rent_cost_types['Year'], y=rent_cost_types['One-time'], name='One-time', marker_color='#6A1B9A'))
        fig_rent_cost_types.add_trace(go.Bar(x=rent_cost_types['Year'], y=rent_cost_types['Repeating'], name='Repeating', marker_color='#1E88E5'))
